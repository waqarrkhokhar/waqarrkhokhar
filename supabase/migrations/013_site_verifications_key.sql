-- ── Migration 013: allow the storefront to read site_verifications ──────────
-- Adds the `site_verifications` key (Google/Bing/Pinterest/Meta/Yandex/Ahrefs
-- ownership tags + Microsoft Clarity id) to the public-read whitelist so the
-- verification meta tags and Clarity script render for anonymous visitors.

...
const NAV: Item[] = [
  { kind: "leaf", label: "Dashboard", href: "/dashboard", icon: "M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z", ready: true },
  {
    ...
    children: [
      ...
      { label: "Custom Fields", href: "/dashboard/custom-fields", cap: "settings" },
      { label: "Structure Manager", href: "/dashboard/structure", cap: "settings" },
    ],
  },
  ...
  },
  {
    ...
    children: [
      { label: "Header Builder", href: "/dashboard/appearance/header", cap: "settings" },
      { label: "Footer Builder", href: "/dashboard/appearance/footer", cap: "settings" },
      { label: "Theme & Display", href: "/dashboard/appearance", cap: "settings" },
    ],
  },
  {
    kind: "group",
